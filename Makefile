...
.PHONY: quant-data-build quant-data-test strategy-test tool-catalog-check job-smoke test clean help
...
tool-catalog-check: ## Validate tools/catalog.yaml entrypoints and metadata
...
test: tool-catalog-check quant-data-test strategy-test job-smoke ## Run retained-stack checks
